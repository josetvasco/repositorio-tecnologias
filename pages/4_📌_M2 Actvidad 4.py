...
st.subheader("Filtrar por salario mínimo")

code = """"
    import streamlit as st
    import  pandas as pd

    salario_min = st.slider("Salario mínimo:", min_value=3000, max_value=6000, step=100, value=3000)
...
st.subheader("Seleccionar fila por posición")
...
code = """
    ...
    col_mod = st.selectbox("Columna a modificar:", df.columns)
